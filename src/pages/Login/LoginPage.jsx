          ...
          <div className="space-y-4">
            ...
            <div className="pt-4">
              <button
                ...
                disabled={
                  isLoading || !mobile || mobile.length < 10 || !countryCode
                }
            ...
            <div className="pt-2">
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                <p className="text-xs text-blue-700 text-center">
                  🚀 <strong>Instant Access:</strong> No OTP required! Sign in
                  directly with your mobile number.
                </p>
              </div>
            </div>
          </div>
